...
@section('settings-tab')
    <div class="ks-settings-tab">
        ...
        <div class="ks-form ks-billing"> <!-- ks-uppercase ks-light -->
            <h3 class="ks-header">Educations &amp; Certifications</h3>
            ...
            <div class="card panel panel-default ks-information ks-light">
                ...
                <div class="card-block ks-payment-methods">
                    ...
                    @foreach(\App\users::find(\Illuminate\Support\Facades\Auth::user()->getAuthIdentifier())->getByMeta('education')->get() as $edu)
                        ...
                        <div class="ks-payment-method">
                            ...
                            <div class="col-lg-2 pull-right">
                                ...
                                <button type="button" class="btn btn-primary ks-light ks-no-text" data-content="{{$edu->id}}"><span class="la la-trash-o ks-icon del-work"></span></button>
                            </div>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form class="ks-form ks-experience" id="form_add_xp"> <!-- ks-uppercase ks-light -->
                            ...
                            <div class="ks-group">
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" class="form-control" name="institue" placeholder="School/College/University">
                                    </div>
                            ...
                            <div class="ks-group">
                                <button type="submit" class="btn btn-success" name="edusubmit" value="add">
        ...
        (function ($) {
            $(document).ready(function() {
                ...
                $(document).on('click','.del-work',function(e){
                    $.post( "", {"edusubmit":"del","content":$(this).parent().attr('data-content')},function( data ) {
                        var obj = jQuery.parseJSON( data );
                        if(obj[0].status === 'success')
                        {
                            new Noty({
